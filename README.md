...
API" section. It can't fire real commands itself (browsers can't open raw UDP
sockets) — use the tools below for that.
...
- `tools/activate-scent.js` — CLI that sends one real UDP command to a
  generator.
